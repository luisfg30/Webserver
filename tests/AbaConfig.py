...
class AbaConfig(Frame):
    ...
    def createWidgets(self):
        ...
        Label(self, text="Máximo de Conexões:").grid(row=1, column=1)
        Label(self, text="Porta:").grid(row=2, column=1)
        Label(self, text="Time Out(segundos):").grid(row=3, column=1)
        ...
        self.eMaxC.grid(row=1, column=2)
        self.ePorta.grid(row=2, column=2)
        self.eTime.grid(row=3, column=2)
        self.cDownload.grid(row=4, column=1)
