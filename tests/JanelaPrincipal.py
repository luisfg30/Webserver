from tkinter import *
import AbaConfig as CFG
import AbaConexao as CNX
...
class JanelaPrincipal(Frame):
    ...
    def __init__(self, master):
        ...
        self.tabs = {}
        frame1 = Frame()
        frame2 = CFG.AbaConfig()
        frame3 = CNX.AbaConexao()
        self.addTab("Conexões Ativas","#9999FF", "#4444FF",frame3)
        self.addTab("Indicadores","#FF9999", "#FF4444",frame1)
        self.addTab("Consulta BD","#99FF99", "#44FF44",frame1)
